...
Guiding Question:
- What is the project
  The project is resume
- Whats the purpose
  To create a resume that shows my education, skills, experience, and hobby.
- What are key components
  Website with links
  Hover with transition
  Transform
  Cards
  Css icon from boxicons
- What technology used and how it is used
  Technology used are HTML and External CSS
